...
themetype="theme-one"
githubUrl="https://raw.githubusercontent.com/ide1234000/sspanel-theme-homepage/master"
#日志
...
echo -e "${Info} github地址:https://github.com/ide1234000/sspanel-theme-homepage"
